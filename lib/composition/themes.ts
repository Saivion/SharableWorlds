...
export const THEMES: ThemeSpec[] = [
  {
    ...
    primary: "grass",
    secondary: [
      { m: "grass-dark", share: [0.12, 0.22] },
      { m: "moss", share: [0.06, 0.14] },
      { m: "grass-dry", share: [0.05, 0.1] },
    ],
    accent: [
      { m: "dirt", share: [0.05, 0.12] },
      { m: "ochre", share: [0.03, 0.07] },
    ],
    rare: [
      { m: "stone", share: [0.02, 0.05] },
      { m: "coral", share: [0.01, 0.03] },
    ],
    pathMaterial: "dirt",
    boundary: "trees",
  ...
  },
  {
    ...
    rare: [
      { m: "ochre", share: [0.02, 0.05] },
      { m: "terracotta", share: [0.01, 0.04] },
    ],
    pathMaterial: "dirt",
    boundary: "trees",
  ...
  },
  {
    ...
    primary: "sand",
    secondary: [
      { m: "sand-dark", share: [0.14, 0.24] },
      { m: "earth-cracked", share: [0.1, 0.18] },
      { m: "ochre", share: [0.06, 0.12] },
    ],
    accent: [
      { m: "terracotta", share: [0.05, 0.12] },
      { m: "ember", share: [0.04, 0.09] },
    ],
    rare: [
      { m: "coral", share: [0.02, 0.05] },
      { m: "dirt", share: [0.01, 0.04] },
    ],
  ...
  },
  {
    ...
    vocab: ["industrial", "factory", "warehouse", "district", "urban", "concrete", "workshop"],
    primary: "sand-dark",
    secondary: [
      { m: "earth-cracked", share: [0.14, 0.24] },
      { m: "stone", share: [0.1, 0.18] },
      { m: "dirt", share: [0.06, 0.12] },
    ],
    accent: [
      { m: "ochre", share: [0.06, 0.14] },
      { m: "terracotta", share: [0.05, 0.11] },
    ],
    rare: [
      { m: "ember", share: [0.03, 0.07] },
      { m: "coral", share: [0.02, 0.05] },
    ],
    pathMaterial: "road",
    boundary: "stones",
    boundaryQuery: "rock stone crate barrel industrial",
    boundaryDensity: [0.2, 0.4],
    undergrowthQuery: "rock crate barrel stone",
  },
  {
    id: "mycel",
